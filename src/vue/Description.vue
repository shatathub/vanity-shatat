<template>
    <div class="panel">
        <p>
            Vanity-Shatat is an open-source tool that uses your web browser to generate Shatat vanity addresses.<br />
        ...
        <p>
            ...
            browser tab.<br /><br />
            <b>Vanity-Shatat cannot and will never store your private key.</b> If you have concerns about its
            ...
            seamlessly<br />
            &nbsp;-&nbsp;Alternatively, you can download the latest build of Vanity-Shatat
            <a href="https://vanty.shatat.ir" target="_blank">here</a> and use it on an offline computer<br />
            &nbsp;-&nbsp;The code is 100% open source and available on
            <a href="https://github.com/shatathub/vanity-Shatat" target="_blank">GitHub</a>, allowing you to review it
            thoroughly before usage<br />
            <br />
            Vanity-Shatat uses a cryptographically secure pseudorandom number generator (CSPRNG) to generate Shatat
            addresses.<br />
        ...
        <p>
            Be aware that due to its popularity and open-source nature, Vanity-Shatat has been widely copied, leading to
            ...
            Vanity-Shatat has always been the <b>first</b> browser-based Shatat vanity address generator, and remains the most
            popular and trusted one.<br /><br />
            To be sure you're on the real Vanity-Shatat website, search for
            <a href="https://github.com/search?o=desc&q=Vanity-Shatat&s=stars" target="_blank">Vanity-Shatat on GitHub</a>,
            find the repository with the most stars (> 600), and click the link in the description. Double check by
            searching <a href="https://www.google.com/search?q=Vanity-Shatat" target="_blank">Vanity-Shatat on Google</a>.
        </p>
        <h2>Performance</h2>
        <p>
            Vanity-Shatat's performance may vary significantly across different browsers. Currently, Chrome provides the
            best results.<br />
            While you can use Vanity-Shatat on your phone or tablet, it is unlikely to match the speed of a traditional
            computer.<br /><br />
            <b>N.B:</b> Vanity-Shatat is designed to be a user-friendly tool that runs directly in your browser, providing
        ...
        <h2>Compatibility</h2>
        <p>
            Any address generated with Vanity-Shatat is SRC-20 compatible, which means you can use it for an ICO, an
            airdrop, or just to withdraw your funds from an exchange.<br />
            The keystore file is 100% compatible with MyShataterWallet, MetaMask, Mist, and Shtat WALLETS.
        </p>
    </div>
</template>
